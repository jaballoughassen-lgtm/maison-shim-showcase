...
Tu peux voir le site en ligne ici : *https://jaballoughassen-lgtm.github.io/maison-shim-showcase/*
...
1. Clone ce répertoire :
   ```bash
   git clone [https://github.com/](https://github.com/)[/maison-shim-showcase/]/[/maison-shim-showcase/].git
